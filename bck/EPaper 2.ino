...
#include <GxEPD2_3C.h>
#include "libraries/Adafruit_GFX_Library/Fonts/FreeMonoBold9pt7b.h"
...
const char BitcoinLabel[] = "Bitcoin";
const char BitcoinValue[] = "10000";

void printBitcoinLabel()
{
  display.setRotation(1);
  display.setFont(&FreeMonoBold9pt7b);
  display.setTextColor(GxEPD_BLACK);
  int16_t tbx, tby; uint16_t tbw, tbh;
  display.getTextBounds(BitcoinLabel, 0, 0, &tbx, &tby, &tbw, &tbh);
...
void printBitcoinValue()
{
  ...
  display.getTextBounds(BitcoinValue, 0, 0, &tbx, &tby, &tbw, &tbh);
  uint16_t x = ((display.width() - tbw) / 2) - tbx;
